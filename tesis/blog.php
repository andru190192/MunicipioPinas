        ...
        <div class="row blog-post-page">
          <div class="col-md-9 blog-box">
              ...
              <?php 
                  ...
                  while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                    ...
                    echo " <h2><a href='foro.php?id=$id'>$titulo</a></h2>";
                    echo "  <ul class='post-meta'>";
                    echo "    <li>Autor: <a>$autor</a></li>";
                    echo "    <li>Fecha: $fecha</li>";
                    echo "    <li><a href='foro.php?id=$id'>$respuestas Comentarios</a></li>";
                    echo "  </ul>";
                    echo "  <p>$mensaje</p>";
                    echo "  <a class='main-button' href='foro.php?id=$id'>Ver <i class='fa fa-angle-right'></i></a>";
              echo "</div>";
            echo "</div>";
            }
            ?>
          ...
          <div class="col-md-3 sidebar right-sidebar">
            ...
            <div class="widget widget-popular-posts">
              <h4>Destacados <span class="head-line"></span></h4>
              <ul>
              <?php 
                  include("../Connections/arqueologia.php");
                  $query = "SELECT * FROM  foro WHERE identificador = 0 ORDER BY fecha DESC";
