    ...
    <div id="content">
      <div class="container">
        ...
        <div class="recent-projects">
          <h4 class="title"><span>Galeria de Videos</span></h4>
        ...
        <div class="row">
          <div class="col-md-9">
            ...
            <div class="our-clients">
              ...
              <!-- Classic Heading -->
              <h4 class="classic-title"><span>Auspiciantes</span></h4>

              <div class="clients-carousel custom-carousel touch-carousel" data-appeared-items="4">

                <!-- Client 1 -->
                <div class="client-item item">
                  <a href="#"><img style="width:64px;height:64px" src="images/logoIntituto.png" alt="" /></a>
                </div>
          ...
          <div class="col-md-3">
            <h4 class="classic-title"><span>Quienes nos apoyan</span></h4>
