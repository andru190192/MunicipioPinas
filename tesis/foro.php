    ...
    <div class="page-banner">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <h2>Blog</h2>
            <p>Pia&ntilde;as Arqueolog&iacute;co</p>
          </div>
          <div class="col-md-6">
            <ul class="breadcrumbs">
              ...
              while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                $id = $row['ID'];
                $titulo = $row['titulo'];
                echo "<li><a href='foro.php?id=$id'>$titulo</a></li>";
            }
            ?>
            </ul>
          </div>
          ...
          <div class="col-md-9 blog-box">
              ...
              while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)){
                ...
                $respuestas = $row['respuestas'];
                    ...
                    echo "      <div class='thumb-overlay'><i class='fa fa-arrows-alt'></i></div>";
                    echo "      <img width='850px' src='../images/slider/prueba.jpg'>";
                    echo "    </a>";
                    echo "  </div>";
                    echo "<div class='post-content'>";
                    echo "<div class='post-type'><i class='fa fa-picture-o'></i></div>";
                    echo " <h2><a>$titulo</a></h2>";
                    echo "  <ul class='post-meta'>";
                    echo "    <li>Autor: <a>$autor</a></li>";
            ...
            <div id="comments">
                <?php
                  ...
                  echo "<h2 class='comments-title'>($respuestas) Comentarios</h2>";
                  ...
                  while($row = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
                    ...
                    echo "    <div class='avatar'><img src='../_admin/assets/img/person.jpg' /></div>";
                    echo "    <div class='comment-content'>";
                    echo "      <div class='comment-meta'>";
                    echo "        <span class='comment-by'>$autor</span>";
                    echo "        <span class='comment-date'>$fecha</span>";
                    echo "      </div>";
                    echo "      <p>$mensaje</p>";
                    echo "    </div>";
                    echo "  </div>";
