          ...
          <aside>
              <div id="sidebar"  class="nav-collapse ">
                  ...
                  <ul class="sidebar-menu" id="nav-accordion">
                      ...
                      <li class="sub-menu">
                          <a class="active" href="historia.php" >
                              <i class="fa fa-book"></i>
                              <span>Historia</span>
                          </a>
                      </li>
          ...
          <div id="content">
            <div class="container" style="text-align:center">
              ...
              <div class="panel panel-primary">
                ...
                <br/>
                <br/>
                <iframe style='width:800px;height:1200px;margin-left:-10px;border:none;'
                src="https://docs.google.com/document/d/1ph9Sc-Fwxai-BuLGVIsDte6LixFK5f339_FDhpOvm04/edit?usp=sharing"></iframe>
              </div>
