    ...
    <table width="100%" border="0" cellpadding="2" cellspacing="2">
      ...
      <tr>
		  ...
		  if ($row_DatosSlider['intestado']== 1)
				...
				echo "Inactivo"; ?></td>
          <td><a href="video_edit.php?recordID=<?php echo $row_DatosSlider['id']; ?>"><img src="images/icono_edit.png" width="16" height="16" /></a> <a href="video_remove.php?recordID=<?php echo $row_DatosSlider['id']; ?>"><img src="images/icono_remove.png" width="16" height="16" onclick="javascript:return asegurar();"/></a></td>
          </tr>
