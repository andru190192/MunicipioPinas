              ...
              <section class="wrapper">
                  <div class="row">
                      ...
                      ?>
                          ...
                          <p>&nbsp;</p>
                          <div class="container">
                          <form class="container" action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                            ...
                            <div class="form-group">
                                <a class="btn btn-primary" href="javascript:document.form1.submit();"><span>Actualizar</span></a>
                                <a class="btn btn-warning" href="video_lista.php"><span>Cancelar</span></a>
                            </div>
