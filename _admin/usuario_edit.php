              ...
              <section class="wrapper">
                  <div class="row">
                      ...
                      if ((isset($_POST["MM_update"])) && ($_POST["MM_update"] == "form1")) {
                        $updateSQL = sprintf("UPDATE usuarios SET usuario=%s, contra=%s, cedula=%s, nombre=%s WHERE idusuario=%s",
                      ...
                      mysql_select_db($database_arqueologia, $arqueologia);
                      $query_DatosSlider = sprintf("SELECT * FROM usuarios WHERE usuarios.idusuario =%s", GetSQLValueString($varDato_DatosSlider, "int"));
