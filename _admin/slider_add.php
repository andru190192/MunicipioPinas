                      ...
                      function subirimagen(nombrecampo)
                      {
                          ...
                          <form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
                            <div class="form-group">
                                  ...
                                  <input id="strimagengrande" type="text" name="strimagengrande" value="" size="32" class="form-control"/>
                            ...
                            <div class="form-group">
                                  ...
                                  <input id="strtitulo" type="text" name="strtitulo" value="" size="32" required class="form-control"/>
                            </div>
                            <div class="form-group">
                                  <label for="ejemplo_email_1">Subtitulo:</label>
                                  <input id="strsubtitulo" type="text" name="strsubtitulo" value="" size="32" class="form-control"/>
                            </div>
                            <div class="form-group">
                                  <label for="ejemplo_email_1">Orden:</label>
                                  <input id="intorden" type="text" name="intorden" value="" size="5" class="form-control"/>
                            </div>
                            <div class="form-group">
